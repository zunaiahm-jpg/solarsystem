...
2. Mission framework + first 3 missions — 2026-09-06
...
- 2026-09-06 — `mission.stepOrder` and `observation.presentation` (table vs. clue list) were added to the schema/runner so Solar System Detective's clues-first flow reuses the same framework instead of forking a second runner.
- 2026-09-06 — Solar System Detective ships beginner-tier only; intermediate/advanced clue-difficulty tiers are deferred rather than half-building a per-mission difficulty-variant system in the same pass.
